...
//    _ = cancellingWKWebViewNavigationDelegate
  ...
  func testViewWithColorComponentTolerance() {
    #if os(iOS)
    // All the reference views have been recorded with a background color of red: 128, green: 0 & blue: 0.
    ...
    XCTExpectFailure("The following assertions are out of the colorimetry delta and should fail") {
      ...
      assertSnapshot(matching: view, as: .image(colorComponentTolerance: delta))
    }
  ...
  func testViewWithDefaultColorComponentTolerance() {
    #if os(iOS)
    // All the reference views have been recorded with a background color of red: 128, green: 0 & blue: 0.

    let delta = 5
    defaultColorComponentTolerance = delta
    let view = UIView(frame: .init(x: 0, y: 0, width: 200, height: 200))
  ...
  func testViewWithDefaultColorComponentToleranceOverridden() {
    #if os(iOS)
    // The reference views have been recorded with a background color of red: 127, green: 0 & blue: 0.
    
    defaultColorComponentTolerance = 1
    let view = UIView(frame: .init(x: 0, y: 0, width: 200, height: 200))

    XCTExpectFailure("The following assertions are out of the colorimetry delta and should fail") {
      view.backgroundColor = colorFromReference(offset: 0)
      assertSnapshot(matching: view, as: .image(colorComponentTolerance: 0))
    }
    #endif
  }

  func testViewControllerWithColorComponentTolerance() {
    #if os(iOS)
    // All the reference view controllers have been recorded with a background color of red: 128, green: 0 & blue: 0.
    ...
    XCTExpectFailure("The following assertions are out of the colorimetry delta and should fail") {
      ...
      assertSnapshot(matching: vc, as: .image(on: .iPhoneX, colorComponentTolerance:-delta))
    }
  ...
  func testViewControllerWithDefaultColorComponentTolerance() {
    #if os(iOS)
    // All the reference view controllers have been recorded with a background color of red: 128, green: 0 & blue: 0.
  ...
  func testViewControllerWithDefaultColorComponentToleranceOverridden() {
    #if os(iOS)
    // The reference views have been recorded with a background color of red: 127, green: 0 & blue: 0.
    ...
    XCTExpectFailure("The following assertions are out of the colorimetry delta and should fail") {
      vc.view.backgroundColor = colorFromReference(offset: 0)
      assertSnapshot(matching: vc, as: .image(on: .iPhoneX, colorComponentTolerance: 0))
    }
    #endif
  }
}
